    ...
    "Subnets": [
        {
            ...
            "SubnetArn": "arn:aws:ec2:us-east-1:*************:subnet/subnet-0f3036538c81def25",
            "EnableDns64": false,
            "Ipv6Native": false,
  ...
  --allocated-storage 20
{
    "DBInstance": {
        ...
        "DBInstanceArn": "arn:aws:rds:us-east-1:*************:db:dos-15-mikhalenka-rds",
...
slava@phobos:~$ aws rds create-db-snapshot --db-instance-identifier dos-15-mikhalenka-rds --db-snapshot-identifier dos-15-mikhalenka-rds-snapshot
{
    "DBSnapshot": {
        ...
        "StorageType": "gp2",
        "Encrypted": false,
        "DBSnapshotArn": "arn:aws:rds:us-east-1:*************:snapshot:dos-15-mikhalenka-rds-snapshot",
        "IAMDatabaseAuthenticationEnabled": false,
        "ProcessorFeatures": [],
        "DbiResourceId": "db-UHJNDO5IMCK2HCY5KACOAHRFKI",
        "TagList": [],
...
slava@phobos:~$ aws rds restore-db-instance-from-db-snapshot --db-instance-identifier dos-15-mikhalenka-rds-new --db-snapshot-identifier dos-15-mikhalenka-rds-snapshot{
    "DBInstance": {
        ...
        "CopyTagsToSnapshot": false,
        "MonitoringInterval": 0,
        "DBInstanceArn": "arn:aws:rds:us-east-1:*************:db:dos-15-mikhalenka-rds-new",
        "IAMDatabaseAuthenticationEnabled": false,
        "PerformanceInsightsEnabled": false,
        "DeletionProtection": false,
        "AssociatedRoles": [],
